...
test('renders hero image with children', () => {
  render(<HeroImage bgImage="https://via.placeholder.com/1200x400">Hero Content</HeroImage>);
...
test('applies correct styles when disabled', () => {
  render(<HeroImage bgImage="https://via.placeholder.com/1200x400" disabled>Disabled Hero Content</HeroImage>);
